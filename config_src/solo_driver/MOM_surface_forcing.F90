...
use Neverworld_surface_forcing, only : Neverworld2_wind_forcing
...
subroutine set_forcing(sfc_state, forces, fluxes, day_start, day_interval, G, US, CS)
  ...
  if (CS%variable_winds .or. CS%first_call_set_forcing) then
    ...
    elseif (trim(CS%wind_config) == "Neverland" .or. trim(CS%wind_config) == "Neverworld") then
      call Neverworld_wind_forcing(sfc_state, forces, day_center, G, US, CS%Neverworld_forcing_CSp)
    elseif (trim(CS%wind_config) == "Neverworld2") then
      call Neverworld2_wind_forcing(sfc_state, forces, day_center, G, US, CS%Neverworld_forcing_CSp)
